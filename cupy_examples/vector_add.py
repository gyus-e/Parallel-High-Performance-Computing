...
@ct.kernel
def vector_add_kernel(a: cp.ndarray, b: cp.ndarray, c: cp.ndarray, tile_size: ct.Constant[int]):
    # Get the 1D bid
    bid = ct.bid(0)
...
def vector_add(a: cp.ndarray, b: cp.ndarray, c: cp.ndarray, tile_size: ct.Constant[int]):
